...
import {
  ButtonAdmin,
  Inputs,
} from "./empleadosComponents.jsx";
import { EmpleadosLayout } from "./EmpleadoLayout.jsx";
...
export const ContainerCrearReservaEmp = () => {
    const initialState = {
      id: "",
      nombre_cliente: "",
      telefono: "",
      ...
      if (formData && Object.values(formData).every((value) => value !== "")) {
        fetch("http://localhost:3000/api/reserva/insertar", {
          ...
          .then(async (response) => {
            ...
            navigate(ROUTES.RESERVA_INSERTAR_EMP);
  ...
  export const ContainerBuscarReservaEmp = () => {
